...
void serialEvent() {   
  ...
  pinVal = HIGH;   }
  //This currrently supports truning one pin high
  //subsequent commands can be made available in the bitvoicer setup and 
  // used to switch pins or make a send a prest emergenc message via a GSM module
} 
